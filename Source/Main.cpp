...
int main()
{
	// Add the file device for this project:
	FileSystem::Get().AddFileDevice({ "Projects/LD46/Data/",FileDevice::Type::Assets,"data" });
	...
	Image* img = Image::CreateFromFile("data:Grid.png");
